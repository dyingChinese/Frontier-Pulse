...
export default tsEslint.config({
	...
	ignores: ['src/assets/translations/*', '**/android', '**/ios', '**/package.json', '**/__mocks__', '**/jest-setup', '**/app.json', '**/.eslintrc.js', '**/*.config.js', '**/coverage', '**/node_modules', '**/*.d.ts', 'src/utils/graphql/generated.ts', 'src/dev-only-purpose', '**/__generated__'],
	rules: {
